...
## Overview
The majority of actual enterprises utilize Windows as their primary operating system to manage identities, users, rights, and rules.

## Security Relevance
Windows is the environment where most real-world enterprise cyberattacks and defences take place. 
Understanding local Windows administration, user permissions, and service management provides the critical groundwork required to read Windows Event Logs,
harden local endpoint configurations, and investigate compromise or Active Directory attacks.

## What I Learned (Learning Objectives)
I explored the fundamentals of the Windows operating system.
...
Through a hands-on lab of a virtual computer, using the Windows Server 2019 operating system to read files, install programs, 
and run security scans on your new workstation.
I navigated the Windows interface, examined system properties, learned about application management, worked with files and folders, 
and managed security settings that make up a Windows environment.
